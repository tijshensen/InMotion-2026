...
export function StartLogin({
  ...
  if (signedIn) {
    return (
      <a
        href={continueHref}
        className="inline-flex w-full items-center justify-center rounded-lg bg-blue-600 px-5 py-3 text-sm font-medium text-white hover:bg-blue-700"
      >
        Continue
      </a>
    );
  ...
  if (!googleReady) {
    return (
      <p className="text-sm text-slate-500">
        ...
        <code className="rounded bg-slate-100 px-1">GOOGLE_CLIENT_SECRET</code>.
      </p>
    );
  }
